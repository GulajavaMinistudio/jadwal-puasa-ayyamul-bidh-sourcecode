...
2. **Glob and Read** existing `.github/instructions/memory.instructions.md` and `.github/instructions/*-memory.instructions.md` files to understand current domain structure
...
5. **Determine target domain(s)**:
   ...
   - For universal learnings, use `.github/instructions/memory.instructions.md`
   - If no good domain match exists, create new domain-specific file like `.github/instructions/{domain}-memory.instructions.md`
